...
namespace Aquatric2 {
    public partial class AdminSide_DailyReport1 : Form {
        ...
        private void AdminSide_DailyReport1_Load(object sender, EventArgs e) {
            ...
            int number = AdminSide_DailyReport.dateForComboBox;
            ...
            performComboBox(number);
            perform1ComboBox(number);
