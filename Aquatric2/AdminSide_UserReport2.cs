...
namespace Aquatric2 {
    public partial class AdminSide_UserReport2 : Form {
        ...
        private void AdminSide_UserReport2_Load(object sender, EventArgs e) {
            userIDText.Text = AdminSide_UserReport.idNumberToPass;
            //latest bills
